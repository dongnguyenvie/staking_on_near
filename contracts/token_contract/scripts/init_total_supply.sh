...
near call $CONTRACT_NAME new '{"owner_id": "'$OWNER_ID'", "total_supply": "1000000000000", "metadata": { "spec": "ft-1.0.0", "name": "Nolan Token", "symbol": "NTK", "decimals": 12 }}' --accountId $CONTRACT_NAME